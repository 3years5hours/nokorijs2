...
<!--
    ...
    var d = "<span class='label2'>年内発送は12/26ご注文分までとなります。<br>12/27～1/4のご注文分は1/5発送予定となります。<\/span>"
    var e = "<span class='label2'>在庫少数のため増刷中です。本日のご注文は10/24(月)の発送となります。<\/span>"
    var f = "<span class='label2'>※6月1日より販売を再開いたします。<\/span>"
